...
final class FirebaseAuthManager extends IBaseFirebaseAuth {
  ...
  Future<UserCredential> signInWithEmailAndPassword(String email, String password) async {
    try {
      if(!email.isValidEmailRegex) throw CustomFirebaseAuthException('email-not-valid');
      if(password.isValidMediumPassword) throw CustomFirebaseAuthException('password-not-valid');
      if(userId.isNullOrEmpty) throw CustomFirebaseAuthException('user-not-login');
      //
